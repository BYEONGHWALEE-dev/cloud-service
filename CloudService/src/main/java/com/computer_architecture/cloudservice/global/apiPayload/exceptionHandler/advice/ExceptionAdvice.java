package com.computer_architecture.cloudservice.global.apiPayload.exceptionHandler.advice;
...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    */
    ...
    public ResponseEntity onThrowException(BaseException baseException, HttpServletRequest request) {
        ErrorReasonDTO errorReasonHttpStatus = baseException.getErrorHttpReason();
